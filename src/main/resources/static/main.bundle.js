...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__tasks_tasks_service__ = __webpack_require__("../../../../../src/app/tasks/tasks.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["E" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_7__tasks_tasks_service__["a" /* TasksService */]],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__task__ = __webpack_require__("../../../../../src/app/tasks/task.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_moment__ = __webpack_require__("../../../../moment/moment.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_moment__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__tasks_service__ = __webpack_require__("../../../../../src/app/tasks/tasks.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var TasksAddComponent = (function () {
    function TasksAddComponent(_tasksService) {
    ...
    TasksAddComponent.prototype.onTaskAdd = function (event) {
        var _this = this;
        var task = new __WEBPACK_IMPORTED_MODULE_1__task__["a" /* Task */](event.target.value, false, __WEBPACK_IMPORTED_MODULE_2_moment__().format('DD/MM/YYYY'));
        this._tasksService.addTask(task).subscribe(function (newTask) {
            event.target.value = '';
            _this._tasksService.onTaskAdded.emit(newTask);
        });
    };
    TasksAddComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_3__tasks_service__["a" /* TasksService */]])
    ], TasksAddComponent);
...
module.exports = "<ul class=\"list-group\" *ngFor=\"let task of tasks\">\n    <li class=\"list-group-item\">\n        <div class=\"form-check\">\n            <label class=\"form-check-label\">\n                <input type=\"checkbox\"\n                       class=\"form-check-input\"\n                       (change)=\"onTaskChange($event, task)\"\n                       [checked]=\"task.completed\">\n                <span ngClass=\"{{task.completed ? 'name completed' : 'name'}}\">{{task.name}}</span>\n            </label>\n            <span class=\"badge {{ getDueDateByLabel(task) }} float-right\">{{task.dueDate}}</span>\n        </div>\n    </li>\n</ul>\n"
...
var TasksListComponent = (function () {
    function TasksListComponent(_tasksService) {
        this._tasksService = _tasksService;
        this.tasks = [];
    }
    TasksListComponent.prototype.ngOnInit = function () {
        ...
        this._tasksService.onTaskAdded.subscribe(function (newTask) {
            _this.tasks.push(newTask);
        });
    };
    TasksListComponent.prototype.getDueDateByLabel = function (task) {
...
// module
exports.push([module.i, "#tasks-panel {\n    margin-top: 4rem;\n}\n", ""]);
...
var TasksService = (function () {
    ...
    TasksService.prototype.saveTask = function (task, checked) {
